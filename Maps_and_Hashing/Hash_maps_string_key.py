...
Your table will store strings in the buckets. 
The (bucket) index is calculated by the first two letters of the string, according to the formula below:
Hash Value = (ASCII Value of First Letter * 100) + ASCII Value of Second Letter
In the formula above, the generated hash value is the (bucket) index.
Example: For a string "UDACITY", 
the ASCII value for letters 'U' and 'D' are 85 and 68 respectively. 
